...
public class EsferaMDL extends Figura {
    ...
    TransformGroup crearObjetoMDL(String archivo, float multiplicadorEscala) {
        ...
        try {
            ...
            if (archivo.equals("src/resources/objetosMDL/Iron_Golem.mdl")) {
            ...
            if (archivo.equals("src/resources/objetosMDL/Doomknight.mdl")) {
            ...
            if (archivo.equals("src/resources/objetosMDL/Dire_Cat.mdl")) {
            ...
            if (archivo.equals("src/resources/objetosMDL/pixie.mdl")) {
