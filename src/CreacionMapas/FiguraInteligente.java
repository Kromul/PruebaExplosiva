...
public class FiguraInteligente {
    ...
    ArrayList<FiguraInteligente> listaObjetosFisicos;
    ...
    public FiguraInteligente objetivo;                      //El objetivo puede ser: localizar otra figura,
    ...
    public void crearPropiedades(float masa, float elasticidad, float dumpingLineal, float posX, float posY, float posZ, DiscreteDynamicsWorld mundoFisico) {
        ...
        identificadorFigura = 100;//listaObjetosFisicos.size() - 1;
...
//                System.out.println("Error: Ya eliminado");
    ...
    public void asignarObjetivo(FiguraInteligente Objetivo, float aceleracionMuscular) {
